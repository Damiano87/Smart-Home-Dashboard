...
//     minute: "2-digit",
//   });
//   const roomKey = item.device.room.name.toLowerCase();

//   if (!grouped[timeLabel]) {
//     grouped[timeLabel] = { time: timeLabel };
//   }
//   grouped[timeLabel][roomKey] = item.value;
// });

// const temperatureData = Object.values(grouped).sort(
//   (a, b) =>
